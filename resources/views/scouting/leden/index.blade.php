<x-layouts.portaal title="Leden — Scouting">
    ...
    <div class="max-w-2xl mx-auto px-4 pt-10 pb-16">
        ...
        <div class="sc-page-header mb-6">
            ...
            <div>
                <h1>Leden</h1>
                <p id="aantal-tekst">{{ $leden->count() }} {{ $leden->count() === 1 ? 'lid' : 'leden' }}</p>
            </div>
            <form id="lid-toevoegen-form" method="post" action="{{ route('scouting.leden.opslaan') }}" class="flex gap-2 ml-auto">
                @csrf
