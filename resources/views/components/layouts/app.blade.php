...
<body class="bg-gray-100 min-h-screen">
    ...
    <nav class="bg-white shadow-sm px-6 py-4 flex items-center gap-6">
        <a href="{{ route('home') }}" class="text-sm text-gray-400 hover:text-indigo-600 transition-colors flex items-center gap-1">
        ...
        <a href="{{ route('budget.home') }}" class="text-xl font-bold text-indigo-600 tracking-tight">Budget</a>
