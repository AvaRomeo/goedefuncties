...
<style>
    ...
    /* Gras berm langs het hele spoor */
    #trein-berm {
        position: absolute;
        bottom: 13px;
        left: 0;
        ...
        height: 15px;
        background:
            repeating-linear-gradient(100deg, transparent 0 12px, rgba(255, 255, 255, 0.12) 12px 13px, transparent 13px 26px),
            repeating-linear-gradient(78deg, transparent 0 18px, rgba(33, 97, 31, 0.34) 18px 20px, transparent 20px 36px),
            linear-gradient(180deg, #7fbd58 0%, #5aa143 38%, #3f7c31 100%);
        z-index: 0;
        box-shadow: inset 0 4px 0 rgba(255, 255, 255, 0.12), inset 0 -3px 0 rgba(34, 84, 32, 0.35);
    }
    ...
    #trein-berm::before {
        top: -4px;
        height: 8px;
        background: repeating-linear-gradient(90deg, transparent 0 14px, #2f7430 14px 16px, transparent 16px 29px);
        opacity: 0.7;
    }
    ...
    #trein-berm::after {
        ...
        height: 7px;
        background:
            radial-gradient(circle at 8% 45%, #ffd657 0 1px, transparent 2px),
            radial-gradient(circle at 18% 65%, #f5f0a8 0 1px, transparent 2px),
            radial-gradient(circle at 29% 42%, #e85d73 0 1px, transparent 2px),
            radial-gradient(circle at 43% 58%, #fff1a2 0 1px, transparent 2px),
            radial-gradient(circle at 57% 43%, #f2c84b 0 1px, transparent 2px),
            radial-gradient(circle at 72% 64%, #e85d73 0 1px, transparent 2px),
            radial-gradient(circle at 88% 48%, #fff1a2 0 1px, transparent 2px);
    ...
    /* Ronde loofbomen met meerdere groentinten */
    .loofboom {
        bottom: 23px;
        width: 32px;
        height: 44px;
    ...
    .loofboom::before {
        ...
        border-radius: 50%;
        background:
            radial-gradient(circle at 30% 32%, #78bd4b 0 27%, transparent 28%),
            radial-gradient(circle at 62% 28%, #5fa43d 0 30%, transparent 31%),
            radial-gradient(circle at 48% 58%, #3e822f 0 42%, transparent 43%),
            radial-gradient(circle at 50% 50%, #4f9837 0 70%, #2f6925 100%);
        box-shadow:
            -8px 5px 0 -3px #6aae42,
            8px 6px 0 -4px #34782c,
            0 -6px 0 -5px #86c85a;
    }
    ...
    .loofboom::after {
        ...
        width: 6px;
        height: 14px;
        background: linear-gradient(90deg, #6d421f 0%, #8a592c 52%, #5e371c 100%);
    ...
    .dennenboom::before {
        bottom: 10px;
        border-bottom: 29px solid #2f7f43;
    }

    .dennenboom::after {
        bottom: 0;
        border-bottom: 25px solid #236b38;
        filter: drop-shadow(0 -7px 0 #3d9650);
    }
    ...
    .den-s { transform: scale(0.82); transform-origin: bottom center; }
    .den-l { transform: scale(1.14); transform-origin: bottom center; }

    /* Nederlandse rijtjeshuizen */
    .rijtjeshuis {
        bottom: 18px;
        width: 55px;
        height: 42px;
    ...
    .rijtjeshuis .dak {
        ...
        width: 51px;
        height: 12px;
        background: linear-gradient(135deg, #7d2c16 0%, #a33f1d 52%, #632010 100%);
        clip-path: polygon(0 100%, 12% 18%, 88% 18%, 100% 100%);
    }

    .rijtjeshuis .dak::before {
        content: '';
        position: absolute;
        top: -5px;
        right: 9px;
    ...
    .rijtjeshuis .muur {
        ...
        height: 28px;
        background:
            repeating-linear-gradient(0deg, transparent 0 6px, rgba(112, 45, 28, 0.34) 6px 7px),
            repeating-linear-gradient(90deg, rgba(166, 72, 43, 0.34) 0 8px, transparent 8px 16px),
            linear-gradient(180deg, #c4683d 0%, #aa4f31 100%);
        border-bottom: 2px solid #76331f;
        box-shadow: inset 0 0 0 1px rgba(105, 43, 28, 0.3);
    }

    .rijtjeshuis .muur::before {
        content: '';
        position: absolute;
        top: 5px;
        left: 6px;
        ...
        box-shadow: 16px 0 0 #b8d4e8, 16px 0 0 1px #5e879c, 31px 0 0 #b8d4e8, 31px 0 0 1px #5e879c;
    }

    .rijtjeshuis .muur::after {
        content: '';
        position: absolute;
        bottom: 0;
        left: 20px;
        width: 8px;
        height: 14px;
        background: linear-gradient(90deg, #4f2d20 0 65%, #332018 65% 100%);
        border-radius: 2px 2px 0 0;
        box-shadow: inset 2px 0 0 rgba(255, 255, 255, 0.12);
    }

    .rijtjeshuis-s { transform: scale(0.82); transform-origin: bottom center; }
    ...
    .boerderij .dak {
        ...
        width: 62px;
        height: 17px;
        background: linear-gradient(180deg, #343941 0%, #20242a 100%);
        clip-path: polygon(8% 100%, 24% 12%, 76% 12%, 92% 100%);
    }
    ...
    .boerderij .muur {
        ...
        width: 52px;
        height: 24px;
        background: linear-gradient(180deg, #e1d1ac 0%, #cdae79 100%);
        border-bottom: 2px solid #8a6b45;
    }

    .boerderij .muur::before {
        content: '';
        position: absolute;
        top: 6px;
        left: 7px;
        ...
        box-shadow: 30px 0 0 #a9c8d9, 30px 0 0 1px #6a8796;
    }

    .boerderij .muur::after {
        content: '';
        position: absolute;
        bottom: 0;
        left: 22px;
    ...
    /* Stationsgebouw naast het perron */
    .stationsgebouw {
        bottom: 36px;
        left: calc(50% + 135px);
        width: 82px;
    ...
    .stationsgebouw .dak {
        ...
        width: 76px;
        height: 14px;
        background: linear-gradient(180deg, #8d3420 0%, #5b2118 100%);
        clip-path: polygon(0 100%, 13% 20%, 87% 20%, 100% 100%);
    }
    ...
    .stationsgebouw .muur {
        ...
        height: 30px;
        background:
            repeating-linear-gradient(0deg, transparent 0 8px, rgba(139, 85, 53, 0.24) 8px 9px),
            linear-gradient(180deg, #d7b77d 0%, #bd9157 100%);
        border: 1px solid #8b623e;
        border-bottom-width: 2px;
    }

    .stationsgebouw .muur::before {
        content: '';
        position: absolute;
        top: 7px;
        left: 8px;
        ...
        height: 9px;
        background: #b8d7e8;
        border: 1px solid #5d8496;
        box-shadow: 21px 0 0 #b8d7e8, 21px 0 0 1px #5d8496, 42px 0 0 #b8d7e8, 42px 0 0 1px #5d8496;
    }

    .stationsgebouw .muur::after {
        content: '';
        position: absolute;
        bottom: 0;
        left: 28px;
    ...
    .bushokje {
        ...
        width: 42px;
        height: 31px;
        border-left: 3px solid #30363c;
        border-right: 3px solid #30363c;
        background: linear-gradient(120deg, rgba(190, 225, 238, 0.72) 0%, rgba(236, 250, 255, 0.35) 48%, rgba(129, 176, 194, 0.55) 100%);
        box-shadow: inset 12px 0 0 rgba(255, 255, 255, 0.22);
    }
    ...
    .lantaarnpaal::before {
        ...
        width: 3px;
        height: 35px;
        background: linear-gradient(90deg, #3d4246 0%, #6d747b 55%, #2f3337 100%);
    }
    ...
    .lantaarnpaal::after {
        ...
        background: radial-gradient(circle at 50% 60%, #fff0a7 0 35%, #f5c94e 58%, #705f2b 100%);
        box-shadow: 0 0 7px rgba(255, 215, 92, 0.55);
    }

    /* Subtiele Nederlandse windmolen op de achtergrond */
    .windmolen {
        bottom: 22px;
        width: 52px;
        height: 58px;
    ...
    .windmolen .molenhuis {
        ...
        width: 18px;
        height: 31px;
        background: linear-gradient(180deg, #d9c79f 0%, #b99562 100%);
        clip-path: polygon(22% 0, 78% 0, 100% 100%, 0 100%);
        border-bottom: 2px solid #7a5a38;
    }

    .windmolen .molenhuis::before {
        content: '';
        position: absolute;
        top: -8px;
        left: 1px;
    ...
    .windmolen .wiek::after {
        ...
        width: 8px;
        height: 12px;
        background: repeating-linear-gradient(0deg, rgba(255, 255, 255, 0.22) 0 2px, transparent 2px 4px);
        border: 1px solid rgba(79, 71, 62, 0.6);
    }
    ...
    @media (max-width: 760px) {
        ...
        .lantaarnpaal { transform: scale(0.88); transform-origin: bottom center; }
    }
    ...
    @media (max-width: 520px) {
        ...
        .loofboom-l,
        .den-l,
        .rijtjeshuis-l { transform: scale(0.9); transform-origin: bottom center; }
    }
</style>
<div id="trein-baan">
        ...
        function rijdTrein() {
            ...
            img.onload = function() {
                ...
                if (stoptAanPerron && opRoute) {
                    ...
                    // Aanrijden: geleidelijk afremmen (ease-out)
                    animeer(img, vanX, stopX, duur * deel, () => {
                        setTimeout(() => {
                            // Vertrekken: geleidelijk optrekken (ease-in)
